...
1. [문서 개요](servicebroker_apiplatform_openstack_install_guide.md#1-문서-개요)
   * 1.1. [목적](servicebroker_apiplatform_openstack_install_guide.md#11-목적)
   * 1.2. [범위](servicebroker_apiplatform_openstack_install_guide.md#12-범위)
   * 1.3. [시스템 구성도](servicebroker_apiplatform_openstack_install_guide.md#13-시스템-구성도)
   * 1.4. [참고자료](servicebroker_apiplatform_openstack_install_guide.md#14-참고자료)
2. [API 플랫폼 서비스팩 설치](servicebroker_apiplatform_openstack_install_guide.md#2-API-플랫폼-서비스팩-설치)
   * 2.1. [설치전 준비사항](servicebroker_apiplatform_openstack_install_guide.md#21-설치전-준비사항)
   * 2.2. [API 플랫폼 서비스 릴리즈 업로드](servicebroker_apiplatform_openstack_install_guide.md#22-API-플랫폼-서비스-릴리즈-업로드)
   * 2.3. [API 플랫폼 서비스 Deployment 파일 수정 및 배포](servicebroker_apiplatform_openstack_install_guide.md#23-API-플랫폼-서비스-deployment-파일-수정-및-배포)
   * 2.4. [API 매니저에서 API 생성 및 배포](servicebroker_apiplatform_openstack_install_guide.md#24-API-매니저에서-API-생성-및-베포)
   * 2.5. [API 플랫폼 서비스 브로커 등록](servicebroker_apiplatform_openstack_install_guide.md#25-API-플랫폼-서비스-브로커-등록)
3. [API 플랫폼 연동 Sample Web App 설명](servicebroker_apiplatform_openstack_install_guide.md#3-API-플랫폼-연동-sample-web-app-설명)
   * 3.1. [Sample Web App에 서비스 바인드 신청 및 App 확인](servicebroker_apiplatform_openstack_install_guide.md#31-sample-web-app에-서비스-바인드-신청-및-app-확인)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/시스템구성도.png)
...
> `$ ls –all`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image3.png)
...
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image4.png)
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image5.png)

* 업로드 된API 플랫폼 릴리즈를 확인한다.

> `$ bosh releases`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image6.png)
>
...
> `$ ls -all`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image7.png)
...
> `$ bosh status`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image8.png)

* Deploy시 사용할 Stemcell을 확인한다. \(Stemcell 3147 버전 사용\)

> `$ bosh stemcells`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image9.png)
>
...
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image10.png)

* API 플랫폼 서비스팩을 배포한다. 환경에 따라 다르지만 API 플랫폼 서비스팩 배포는 일반적으로 30분에서 50분 가량이 소요된다. 

> `$ bosh deploy`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image11.png)
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image12.png)

* 배포된 API 플랫폼 서비스팩을 확인한다.

> `$ bosh vms`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image13.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image14.png)

\(2\) 터널링 정보를 입력한다.  
 ① Source port에 사용하지 않는 임의의 포트를 입력하고 ②번 Dynamic을 선택한 후, ③ Add 버튼을 눌러 추가한다. ④번 위치에서 D{입력한 포트}의 형태로 추가된 것을 확인한다.

> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image15.png)

\(3\) Putty 접속 정보를 입력한다.  
 ① Session 메뉴를 클릭하여 접속정보 설정 화면으로 이동하여 ② 배포한 API 매니저와 내부망으로 연결되어 있는 머신\(설치 환경에 따라 상이함\)의 Public IP를 입력한다.

> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image16.png)

\(4\) Putty 접속 및 로그인  
 Open 버튼을 클릭하여 해당 머신에 연결한다

> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image17.png)

로그인 화면에서 로그인을 완료한 채로 접속을 유지해둔다.

> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image18.png)

**2. Firefox 설정**

\(1\) Mozila Firefox 브라우저를 실행하여 첫 화면 하단의 옵션 버튼을 클릭한다.

> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image19.jpeg)

\(2\) 설정 창을 연다.  
 ① 고급 탭- ② 네트워크 탭- ③ 설정 버튼을 차례로 클릭하여 설정 창을 연다.

> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image20.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image21.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image22.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image23.png)

**2. API 생성**

① 로그인이 완료되면 다음과 같은 화면을 확인할 수 있다. 최초 배포가 완료되면 API가 생성되지 않은 상태이므로 ②번의 New API 버튼이 화면에 보여진다. New API 버튼을 클릭하여 API 생성화면으로 이동한다.

> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image24.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image25.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image26.png)

리소스를 추가하면 하단의 그림처럼 추가된 Resource가 화면에 나타난다. 그 중 GET 메소드의 리소스를 클릭하여 파라미터 세부사항을 정의한다.

> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image27.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image28.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image29.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image30.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image31.png)
...
> `$ cf service-brokers`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image32.png)
...
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image33.png)

* 등록된 API 플랫폼 서비스 브로커를 확인한다.

> `$ cf service-brokers`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image34.png)

* 접근 가능한 서비스 목록을 확인한다.

> `$ cf service-access`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image35.png)
>
...
> `$ cf service-access`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image36.png)

* 서비스가 Marketplace에 등록된 것을 확인한다.

> `$ cf marketplace`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image37.png)
...
> `$ cf push --no-start`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image38.png)

* 배포된 Sample App을 확인하고 로그를 수행한다.

> `$ cf apps`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image39.png)
>
> `$ cf logs hello-servlet-tomcat`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image40.png)
...
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image41.png)

* 생성된 API 플랫폼 서비스 인스턴스를 확인한다.

> `$ cf services`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image42.png)

* 샘플앱과 생성한 서비스 인스턴스를 바인드 한다.

> `$ cf bind-service hello-servlet-tomcat phoneverification-instance-unlimited`
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image43.png)
...
>
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/apiplatform/apiplatform_openstack/image44.png)
