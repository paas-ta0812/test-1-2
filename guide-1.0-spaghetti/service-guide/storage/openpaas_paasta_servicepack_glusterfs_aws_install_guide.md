# GlusterFS 설치 가이드\(AWS\)

1. [문서 개요](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#1)
   * [1.1. 목적](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#2)
   * [1.2. 범위](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#3)
   * [1.3. 시스템 구성도](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#4)
   * [1.4. 참고자료](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#5)
2. [GlusterFS 서비스팩 설치](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#6)
   * [2.1. 설치전 준비사항](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#7)
   * [2.2. GlusterFS 서비스 릴리즈 업로드](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#8)
   * [2.3. GlusterFS 서비스 Deployment 파일 수정 및 배포](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#9)
   * [2.4. GlusterFS 서비스 브로커 등록](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#10)
3. [GlusterFS 연동 Sample App 설명](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#11)
   * [3.1. Sample App 구조](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#12)
   * [3.2. 개방형 클라우드 플랫폼에서 서비스 신청](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#13)
   * [3.3. Sample App에 서비스 바인드 신청 및 App 확인](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#14)
4. [GlusterFS Client 툴 접속](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#15)
   * [4.1. Putty 다운로드 및 터널링](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#16)
   * [4.2. GlusterFS Manager 설치 및 연결](openpaas_paasta_servicepack_glusterfs_aws_install_guide.md#17)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/2-3-3-0.png)

* GlusterFS 서비스팩을 배포한다.

> $ bosh deploy  
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/2-3-4-0.png)  
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/2-3-4-1.png)

* 배포된 GlusterFS 서비스팩을 확인한다.

> $ bosh vms openpaas-glusterfs-service  
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/2-3-5-0.png)
...
> $ cf service-access  
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/2-4-4-0.png)
...
> $ ls -all ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-1-0-0.png)
...
> $ cf marketplace ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-2-0-0.png)
...
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-2-1-0.png)

* 생성된 GlusterFS 서비스 인스턴스를 확인한다.

> $ cf services ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-2-2-0.png)
...
> $ cf push --no-start  
>  ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-3-0-0.png)

* 배포된 Sample App을 확인하고 로그를 수행한다.

> $ cf apps  
>  ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-3-1-0.png)
>
> $ cf logs {배포된 App명}  
>  $ cf logs hello-spring-glusterfs ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-3-1-1.png)

* Sample Web App에서 생성한 서비스 인스턴스 바인드 신청을 한다. 

> $ cf bind-service hello-spring-glusterfs glusterfs-service-instance ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-3-2-0.png)

* 바인드가 적용되기 위해서 App을 재기동한다.

> $ cf restart hello-spring-glusterfs ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-3-3-0.png)  
> ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-3-3-1.png)

* App이 정상적으로 GlusterFS 서비스를 사용하는지 확인한다.

> - curl 로 확인  
>  $ curl --form attchFile=@../../../Desert.jpg --form press=OK hello-spring-glusterfs.115.68.46.30.xip.io/swifttest ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-3-4-0.png)
>
> - 브라우져에서 이미지 확인  
>  ![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-service/glusterfs/glusterfs_aws/3-3-4-1.png)
