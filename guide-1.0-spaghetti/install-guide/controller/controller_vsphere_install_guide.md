...
1. [개요](controller_vsphere_install_guide.md#1-개요)    
   * 1.1. [문서 목적](controller_vsphere_install_guide.md#11-문서-목적)    
   * 1.2. [범위](controller_vsphere_install_guide.md#12-범위)    
   * 1.3. [참고자료](controller_vsphere_install_guide.md#13-참고자료)    
2. [Prerequisites](controller_vsphere_install_guide.md#2-prerequisites)    
   * 2.1. [개요](controller_vsphere_install_guide.md#21-개요)        
   * 2.2. [vSphere](controller_vsphere_install_guide.md#22-vsphere)    
     * 2.2.1. [데이터센터/클러스터/리소스풀](controller_vsphere_install_guide.md#221-데이터센터클러스터리소스풀)
   * 2.3. [Bosh Server 및 Bosh CLI](controller_vsphere_install_guide.md#23-bosh-server-및-bosh-cli)    
   * 2.4. [DNS Server](controller_vsphere_install_guide.md#24-dns-server)    
   * 2.5. [OP CLI](controller_vsphere_install_guide.md#25-op-cli)    
3. [Open PaaS Controller 설치](controller_vsphere_install_guide.md#3-open-paas-controller-설치)    
   * 3.1. [Release Upload](controller_vsphere_install_guide.md#31-release-upload)    
   * 3.2. [Stemcell Upload](controller_vsphere_install_guide.md#32-stemcell-upload)        
   * 3.3. [Deployment Manifest](controller_vsphere_install_guide.md#33-depoyment-manifest)    
     * 3.3.1. [Name & Release](controller_vsphere_install_guide.md#331-name-&-release)        
     * 3.3.2. [Networks](controller_vsphere_install_guide.md#332-networks)    
     * 3.3.3. [Compilation](controller_vsphere_install_guide.md#333-compilation)    
     * 3.3.4. [Resource Pools](controller_vsphere_install_guide.md#334-resource-pools)    
     * 3.3.5. [Update](controller_vsphere_install_guide.md#335-update)    
     * 3.3.6. [Jobs](controller_vsphere_install_guide.md#336-jobs)    
     * 3.3.7. [Properties](controller_vsphere_install_guide.md#337-properties)    
   * 3.4. [Bosh Deploy](controller_vsphere_install_guide.md#34-bosh-deploy)        
     * 3.4.1. [Deployment Manifest 지정](controller_vsphere_install_guide.md#341-deployment-manifest-지정)    
     * 3.4.2. [Open PaaS Controller Deploy](controller_vsphere_install_guide.md#342-open-paas-controller-deploy)    
   * 3.5. [설치형상 확인](controller_vsphere_install_guide.md#35-설치형상-확인)    
4. [설치 검증](controller_vsphere_install_guide.md#4-설치-검증)
   * 4.1. [CF Login](controller_vsphere_install_guide.md#41-cf-login)
   * 4.2. [Application Deploy](controller_vsphere_install_guide.md#42-application-deploy)
   * 4.3. [Application Access](controller_vsphere_install_guide.md#43-application-access)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image002.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image003.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image004.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image005.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image006.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image007.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image008.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image009.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image010.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image011.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image012.png)
...
![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image013.png)

### 4.3. Application Access

Deploy한 Application URL을 Browser 또는 curl 명령어로 Access하여 정상 접근 되는지를 확인한다.

![](https://github.com/paas-ta0812/test-1-2/tree/581ff21f2c0942b5817f22d843f84cee02490039/images/openpaas-controller/controller_vsphere_image014.png)
